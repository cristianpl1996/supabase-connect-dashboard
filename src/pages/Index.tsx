...
const Index = () => {
  ...
  uniqueLabIds.forEach(labId => {
    ...
    const labPromos = promotions.filter(p => 
      p.lab_id === labId && (p.status === 'activa' || p.status === 'borrador')
    );
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Panorama general de todos los laboratorios • {new Date().toLocaleDateString('es-CO', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {promotions.length} promociones en total
            </p>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Promociones que terminan en los próximos 7 días
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Laboratorios con menos del 10% de saldo disponible
            </CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Disponible: {formatCurrency(lab.available)}
                      </p>
                    </div>
