...
const quickActionButtonClass =
  "group relative h-24 overflow-hidden border-border/70 bg-background flex flex-col gap-2 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-[linear-gradient(135deg,#ffffff_0%,#f0fff5_28%,#c9f7d8_64%,#72d895_100%)] hover:text-[#17221b] hover:shadow-[0_18px_45px_-26px_rgba(15,157,88,0.7)] focus-visible:bg-[linear-gradient(135deg,#ffffff_0%,#f0fff5_28%,#c9f7d8_64%,#72d895_100%)] focus-visible:text-[#17221b] [&_svg]:!h-7 [&_svg]:!w-7 [&_svg]:transition-transform [&_svg]:duration-300 hover:[&_svg]:-translate-y-0.5 hover:[&_svg]:scale-110";
