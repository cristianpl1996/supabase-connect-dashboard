        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Genera materiales de venta profesionales en segundos
            </p>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Imagen profesional para Instagram y WhatsApp
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {/* Hidden file input */}
                ...
                >
                  ...
                  <div className="relative h-full p-6 flex flex-col">
                        ...
                        >
                          <div className="flex flex-col items-center text-white/80">
                            ...
                            <span className="text-sm font-medium text-center">
                              📷 Clic para subir<br />foto del producto
                            </span>
                          </div>
                        </div>
                      )}
                    ...
                    <div className="text-center text-white/70 text-xs space-y-1">
                      <p>
                        Válido del {format(new Date(selectedPromo.start_date), "dd/MM/yyyy")} al {format(new Date(selectedPromo.end_date), "dd/MM/yyyy")}
                      </p>
          ...
          <Card className="border-dashed">
            <CardContent className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-muted-foreground mt-2 max-w-md">
                ...
                el texto de WhatsApp y la imagen profesional para redes sociales.
              </p>
            </CardContent>
          </Card>
        )}
